		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "github",
									"targetURL": "#managewogithub-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"managewogithub-display": {
								"semanticObject": "managewogithub",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=managewogithub",
									"url": sap.ui.require.toUrl("managewogithub")
								}
							}
						}
					}
